...
@interface ShowcaseFilterListController ()<UIActionSheetDelegate>
...
{
    UIActionSheet *sheet = [[UIActionSheet alloc]initWithTitle:@"选择功能" delegate:self cancelButtonTitle:@"关闭" destructiveButtonTitle:nil otherButtonTitles:@"照相机",@"相册",@"OK", nil];//关闭按钮在最后
