...
- (void)viewDidLoad {
    ...
    blurImage = [[UIImageView alloc] initWithFrame:self.view.bounds];
    blurImage.image = [UIImage imageNamed:@"blur.jpg"];
    [self.view addSubview:blurImage];
    
//    imageSlider = [[UISlider alloc] initWithFrame:CGRectMake(25.0, mScreenHeight - 50.0, mScreenWidth - 50.0, 40.0)];
...
//    [self.view addSubview:imageSlider];
    ...
    UIImage *blur = [self blurryImage:blurImage.image withBlurLevel:0.6];
...
- (void)updateSliderValue:(id)sender
{
    ...
    UIImage *blur = [self blurryImage:blurImage.image withBlurLevel:1.5];
    blurImage.image = blur;
